...
--
-- Servidor: localhost
-- Tiempo de generación: 28-11-2012 a las 22:07:39
...
('def', 'pivotpoint', 'wp_commentmeta', 'meta_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_commentmeta', 'comment_id', 2, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_commentmeta', 'meta_key', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_commentmeta', 'meta_value', 4, NULL, 'YES', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_ID', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_post_ID', 2, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_author', 3, NULL, 'NO', 'tinytext', 255, 255, NULL, NULL, 'utf8', 'utf8_general_ci', 'tinytext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_author_email', 4, '', 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_author_url', 5, '', 'NO', 'varchar', 200, 600, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_author_IP', 6, '', 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_date', 7, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_date_gmt', 8, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_content', 9, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_karma', 10, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_approved', 11, '1', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_agent', 12, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_type', 13, '', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'comment_parent', 14, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_comments', 'user_id', 15, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_url', 2, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_name', 3, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_image', 4, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_target', 5, '', 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_description', 6, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_visible', 7, 'Y', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_owner', 8, '1', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_rating', 9, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_updated', 10, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_rel', 11, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_notes', 12, NULL, 'NO', 'mediumtext', 16777215, 16777215, NULL, NULL, 'utf8', 'utf8_general_ci', 'mediumtext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_links', 'link_rss', 13, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_options', 'option_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_options', 'option_name', 2, '', 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_options', 'option_value', 3, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_options', 'autoload', 4, 'yes', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_postmeta', 'meta_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_postmeta', 'post_id', 2, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_postmeta', 'meta_key', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_postmeta', 'meta_value', 4, NULL, 'YES', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'ID', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_author', 2, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_date', 3, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_date_gmt', 4, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_content', 5, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_title', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_excerpt', 7, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_status', 8, 'publish', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'comment_status', 9, 'open', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'ping_status', 10, 'open', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_password', 11, '', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_name', 12, '', 'NO', 'varchar', 200, 600, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(200)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'to_ping', 13, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'pinged', 14, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_modified', 15, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_modified_gmt', 16, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_content_filtered', 17, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_parent', 18, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'guid', 19, '', 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'menu_order', 20, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_type', 21, 'post', 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'post_mime_type', 22, '', 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_posts', 'comment_count', 23, '0', 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_relationships', 'object_id', 1, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_relationships', 'term_taxonomy_id', 2, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_relationships', 'term_order', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 'term_taxonomy_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 'term_id', 2, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 'taxonomy', 3, '', 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 'description', 4, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 'parent', 5, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 'count', 6, '0', 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_terms', 'term_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_terms', 'name', 2, '', 'NO', 'varchar', 200, 600, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(200)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_terms', 'slug', 3, '', 'NO', 'varchar', 200, 600, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(200)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_terms', 'term_group', 4, '0', 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(10)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_usermeta', 'umeta_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_usermeta', 'user_id', 2, '0', 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_usermeta', 'meta_key', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_usermeta', 'meta_value', 4, NULL, 'YES', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'ID', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'user_login', 2, '', 'NO', 'varchar', 60, 180, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(60)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'user_pass', 3, '', 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'user_nicename', 4, '', 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'user_email', 5, '', 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'user_url', 6, '', 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'user_registered', 7, '0000-00-00 00:00:00', 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'user_activation_key', 8, '', 'NO', 'varchar', 60, 180, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'user_status', 9, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'pivotpoint', 'wp_users', 'display_name', 10, '', 'NO', 'varchar', 250, 750, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(250)', '', '', 'select,insert,update,references', '');
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '47'),
('CREATED_TMP_DISK_TABLES', '498'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '1754'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '116'),
('HANDLER_READ_KEY', '228'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '1503'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '48'),
('HANDLER_READ_RND_NEXT', '12356'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '9974'),
...
('INNODB_ROWS_READ', '1740'),
('INNODB_ROWS_UPDATED', '0'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '6687'),
('KEY_BLOCKS_USED', '11'),
('KEY_READ_REQUESTS', '82'),
('KEY_READS', '11'),
...
('FLUSH_TIME', '0'),
('GENERAL_LOG_FILE', '/Applications/MAMP/db/mysql/Maqui.log'),
('QUERY_PREALLOC_SIZE', '8192'),
('PERFORMANCE_SCHEMA_MAX_COND_CLASSES', '80'),
('SLOW_QUERY_LOG', 'OFF'),
('AUTO_INCREMENT_INCREMENT', '1'),
('MAX_SEEKS_FOR_KEY', '18446744073709551615'),
('TMPDIR', '/var/folders/3r/rn81hc912sn910nfqxjgf7240000gn/T/'),
('SQL_BIG_SELECTS', 'ON'),
('EXPIRE_LOGS_DAYS', '0'),
...
('SLOW_QUERY_LOG_FILE', '/Applications/MAMP/db/mysql/Maqui-slow.log'),
...
('SLAVE_LOAD_TMPDIR', '/var/folders/3r/rn81hc912sn910nfqxjgf7240000gn/T/'),
...
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_commentmeta', 'meta_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_comments', 'comment_ID', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_links', 'link_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_options', 'option_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'option_name', 'def', 'pivotpoint', 'wp_options', 'option_name', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_postmeta', 'meta_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_posts', 'ID', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_term_relationships', 'object_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_term_relationships', 'term_taxonomy_id', 2, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_term_taxonomy', 'term_taxonomy_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'term_id_taxonomy', 'def', 'pivotpoint', 'wp_term_taxonomy', 'term_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'term_id_taxonomy', 'def', 'pivotpoint', 'wp_term_taxonomy', 'taxonomy', 2, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_terms', 'term_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'slug', 'def', 'pivotpoint', 'wp_terms', 'slug', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_usermeta', 'umeta_id', 1, NULL, NULL, NULL, NULL),
('def', 'pivotpoint', 'PRIMARY', 'def', 'pivotpoint', 'wp_users', 'ID', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2012-11-28 21:07:39', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2011-02-14 14:27:19', '2012-07-10 12:13:05', NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 70, 140, 281474976710655, 2048, 0, '2011-02-14 14:27:20', '2012-07-10 12:13:05', NULL, NULL, '', '', NULL),
...
('def', 'pivotpoint', 'wp_commentmeta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 4194304, '2012-11-27 17:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_comments', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 65536, 4194304, '2012-11-27 17:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_links', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 16384, 4194304, '2012-11-27 17:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_options', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 344, 3667, 1261568, NULL, 16384, 4194304, '2012-11-27 17:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_postmeta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 32768, 4194304, '2012-11-27 17:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_posts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 65536, 4194304, '2012-11-27 17:16:00', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_term_relationships', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 16384, 4194304, '2012-11-27 17:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_term_taxonomy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 32768, 4194304, '2012-11-27 17:15:59', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_terms', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 32768, 4194304, '2012-11-27 17:15:58', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_usermeta', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 1170, 16384, NULL, 32768, 4194304, '2012-11-27 17:15:58', NULL, NULL, NULL, '', '', NULL),
('def', 'pivotpoint', 'wp_users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 32768, 4194304, '2012-11-27 17:15:58', NULL, NULL, NULL, '', '', NULL);
...
(46, 'root', 'localhost', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'pivotpoint', 'latin1', 'latin1_swedish_ci', NULL);
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '10754'),
('INNODB_BUFFER_POOL_READS', '425'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1'),
('INNODB_DATA_FSYNCS', '7'),
...
('def', 'pivotpoint', 'wp_commentmeta', 0, 'pivotpoint', 'PRIMARY', 1, 'meta_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_commentmeta', 1, 'pivotpoint', 'comment_id', 1, 'comment_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_commentmeta', 1, 'pivotpoint', 'meta_key', 1, 'meta_key', 'A', 0, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_comments', 0, 'pivotpoint', 'PRIMARY', 1, 'comment_ID', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_comments', 1, 'pivotpoint', 'comment_post_ID', 1, 'comment_post_ID', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_comments', 1, 'pivotpoint', 'comment_approved_date_gmt', 1, 'comment_approved', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_comments', 1, 'pivotpoint', 'comment_approved_date_gmt', 2, 'comment_date_gmt', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_comments', 1, 'pivotpoint', 'comment_date_gmt', 1, 'comment_date_gmt', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_comments', 1, 'pivotpoint', 'comment_parent', 1, 'comment_parent', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_links', 0, 'pivotpoint', 'PRIMARY', 1, 'link_id', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_links', 1, 'pivotpoint', 'link_visible', 1, 'link_visible', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_options', 0, 'pivotpoint', 'PRIMARY', 1, 'option_id', 'A', 100, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_options', 0, 'pivotpoint', 'option_name', 1, 'option_name', 'A', 100, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_postmeta', 0, 'pivotpoint', 'PRIMARY', 1, 'meta_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_postmeta', 1, 'pivotpoint', 'post_id', 1, 'post_id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_postmeta', 1, 'pivotpoint', 'meta_key', 1, 'meta_key', 'A', 1, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_posts', 0, 'pivotpoint', 'PRIMARY', 1, 'ID', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_posts', 1, 'pivotpoint', 'post_name', 1, 'post_name', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_posts', 1, 'pivotpoint', 'type_status_date', 1, 'post_type', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_posts', 1, 'pivotpoint', 'type_status_date', 2, 'post_status', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_posts', 1, 'pivotpoint', 'type_status_date', 3, 'post_date', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_posts', 1, 'pivotpoint', 'type_status_date', 4, 'ID', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_posts', 1, 'pivotpoint', 'post_parent', 1, 'post_parent', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_posts', 1, 'pivotpoint', 'post_author', 1, 'post_author', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_term_relationships', 0, 'pivotpoint', 'PRIMARY', 1, 'object_id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_term_relationships', 0, 'pivotpoint', 'PRIMARY', 2, 'term_taxonomy_id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_term_relationships', 1, 'pivotpoint', 'term_taxonomy_id', 1, 'term_taxonomy_id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 0, 'pivotpoint', 'PRIMARY', 1, 'term_taxonomy_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 0, 'pivotpoint', 'term_id_taxonomy', 1, 'term_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 0, 'pivotpoint', 'term_id_taxonomy', 2, 'taxonomy', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 1, 'pivotpoint', 'taxonomy', 1, 'taxonomy', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_terms', 0, 'pivotpoint', 'PRIMARY', 1, 'term_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_terms', 0, 'pivotpoint', 'slug', 1, 'slug', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_terms', 1, 'pivotpoint', 'name', 1, 'name', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_usermeta', 0, 'pivotpoint', 'PRIMARY', 1, 'umeta_id', 'A', 14, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_usermeta', 1, 'pivotpoint', 'user_id', 1, 'user_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_usermeta', 1, 'pivotpoint', 'meta_key', 1, 'meta_key', 'A', 14, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_users', 0, 'pivotpoint', 'PRIMARY', 1, 'ID', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_users', 1, 'pivotpoint', 'user_login_key', 1, 'user_login', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'pivotpoint', 'wp_users', 1, 'pivotpoint', 'user_nicename', 1, 'user_nicename', 'A', 1, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2012-11-28 21:07:39', '2012-11-28 21:07:39', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2012-11-28 21:07:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2011-02-14 14:27:19', '2012-07-10 12:13:05', NULL, 'utf8_bin', NULL, '', 'Database privileges'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 70, 140, 281474976710655, 2048, 0, NULL, '2011-02-14 14:27:20', '2012-07-10 12:13:05', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'pivotpoint', 'wp_commentmeta', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 4194304, 1, '2012-11-27 17:15:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_comments', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 65536, 4194304, 2, '2012-11-27 17:15:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_links', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 16384, 4194304, 8, '2012-11-27 17:15:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_options', 'BASE TABLE', 'InnoDB', 10, 'Compact', 380, 3319, 1261568, 0, 16384, 4194304, 195, '2012-11-27 17:15:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_postmeta', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 32768, 4194304, 2, '2012-11-27 17:15:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_posts', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 65536, 4194304, 4, '2012-11-27 17:16:00', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_term_relationships', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 16384, 4194304, NULL, '2012-11-27 17:15:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_term_taxonomy', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 32768, 4194304, 3, '2012-11-27 17:15:59', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_terms', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 32768, 4194304, 3, '2012-11-27 17:15:58', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_usermeta', 'BASE TABLE', 'InnoDB', 10, 'Compact', 14, 1170, 16384, 0, 32768, 4194304, 15, '2012-11-27 17:15:58', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'pivotpoint', 'wp_users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 32768, 4194304, 2, '2012-11-27 17:15:58', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_commentmeta', 'PRIMARY KEY'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_comments', 'PRIMARY KEY'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_links', 'PRIMARY KEY'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_options', 'PRIMARY KEY'),
('def', 'pivotpoint', 'option_name', 'pivotpoint', 'wp_options', 'UNIQUE'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_postmeta', 'PRIMARY KEY'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_posts', 'PRIMARY KEY'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_term_relationships', 'PRIMARY KEY'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_term_taxonomy', 'PRIMARY KEY'),
('def', 'pivotpoint', 'term_id_taxonomy', 'pivotpoint', 'wp_term_taxonomy', 'UNIQUE'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_terms', 'PRIMARY KEY'),
('def', 'pivotpoint', 'slug', 'pivotpoint', 'wp_terms', 'UNIQUE'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_usermeta', 'PRIMARY KEY'),
('def', 'pivotpoint', 'PRIMARY', 'pivotpoint', 'wp_users', 'PRIMARY KEY');
...
--
-- Base de datos: `pivotpoint`
--
CREATE DATABASE `pivotpoint` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `pivotpoint`;
...
(1, 1, 'Sr WordPress', '', 'http://wordpress.org/', '', '2012-11-27 17:16:00', '2012-11-27 17:16:00', 'Hola, esto es un comentario.<br /> Para borrar un comentario sólo tienes que entrar y ver los comentarios de la entrada. Entonces tendrás la opción de editar o borrar.', 0, '1', '', '', 0, 0);
...
(2, 'blogname', 'Pivotpoint', 'yes'),
(3, 'blogdescription', 'Otro sitio realizado con WordPress', 'yes'),
(4, 'users_can_register', '0', 'yes'),
(5, 'admin_email', 'developers@bueninvento.es', 'yes'),
...
(36, 'active_plugins', 'a:1:{i:0;s:43:"the-events-calendar/the-events-calendar.php";}', 'yes'),
(37, 'home', 'http://localhost:8888', 'yes'),
...
(45, 'template', 'pivotpoint', 'yes'),
(46, 'stylesheet', 'pivotpoint', 'yes'),
...
(104, 'cron', 'a:3:{i:1354166164;a:3:{s:16:"wp_version_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:17:"wp_update_plugins";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wp_update_themes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1354191149;a:1:{s:19:"wp_scheduled_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}s:7:"version";i:2;}', 'yes'),
(106, '_site_transient_update_core', 'O:8:"stdClass":3:{s:7:"updates";a:2:{i:0;O:8:"stdClass":9:{s:8:"response";s:6:"latest";s:8:"download";s:49:"http://es.wordpress.org/wordpress-3.4.2-es_ES.zip";s:6:"locale";s:5:"es_ES";s:8:"packages";O:8:"stdClass":4:{s:4:"full";s:49:"http://es.wordpress.org/wordpress-3.4.2-es_ES.zip";s:10:"no_content";b:0;s:11:"new_bundled";b:0;s:7:"partial";b:0;}s:7:"current";s:5:"3.4.2";s:11:"php_version";s:5:"5.2.4";s:13:"mysql_version";s:3:"5.0";s:11:"new_bundled";s:3:"3.2";s:15:"partial_version";s:0:"";}i:1;O:8:"stdClass":9:{s:8:"response";s:6:"latest";s:8:"download";s:40:"http://wordpress.org/wordpress-3.4.2.zip";s:6:"locale";s:5:"en_US";s:8:"packages";O:8:"stdClass":4:{s:4:"full";s:40:"http://wordpress.org/wordpress-3.4.2.zip";s:10:"no_content";s:51:"http://wordpress.org/wordpress-3.4.2-no-content.zip";s:11:"new_bundled";s:52:"http://wordpress.org/wordpress-3.4.2-new-bundled.zip";s:7:"partial";b:0;}s:7:"current";s:5:"3.4.2";s:11:"php_version";s:5:"5.2.4";s:13:"mysql_version";s:3:"5.0";s:11:"new_bundled";s:3:"3.2";s:15:"partial_version";s:0:"";}}s:12:"last_checked";i:1354125187;s:15:"version_checked";s:5:"3.4.2";}', 'yes'),
(110, '_site_transient_update_themes', 'O:8:"stdClass":3:{s:12:"last_checked";i:1354123728;s:7:"checked";a:3:{s:10:"pivotpoint";s:3:"1.4";s:12:"twentyeleven";s:3:"1.4";s:9:"twentyten";s:3:"1.4";}s:8:"response";a:0:{}}', 'yes'),
(111, '_site_transient_timeout_browser_4071fadaf88b07467adaed3daf67fa4c', '1354641374', 'yes'),
(112, '_site_transient_browser_4071fadaf88b07467adaed3daf67fa4c', 'a:9:{s:8:"platform";s:9:"Macintosh";s:4:"name";s:6:"Safari";s:7:"version";s:5:"6.0.2";s:10:"update_url";s:28:"http://www.apple.com/safari/";s:7:"img_src";s:49:"http://s.wordpress.org/images/browsers/safari.png";s:11:"img_src_ssl";s:48:"https://wordpress.org/images/browsers/safari.png";s:15:"current_version";s:1:"5";s:7:"upgrade";b:0;s:8:"insecure";b:0;}', 'yes'),
...
(1, 1, '2012-11-27 17:16:00', '2012-11-27 17:16:00', 'Bienvenido a WordPress. Esta es tu primera entrada. Edítala o bórrala, ¡y comienza a publicar!.', '¡Hola mundo!', '', 'publish', 'open', 'open', '', 'hola-mundo', '', '', '2012-11-27 17:16:00', '2012-11-27 17:16:00', '', 0, 'http://localhost:8888/?p=1', 0, 'post', '', 1),
(2, 1, '2012-11-27 17:16:00', '2012-11-27 17:16:00', 'Esta es una página de ejemplo, Es diferente a una entrada de un blog porque se mantiene estática y, en la mayoría de temas, se mostrará en la barra de navegación. Casi todo el mundo comienza con una página Sobre mí para presentarse a los potenciales visitantes. Puede decir algo así:\n\n<blockquote>¡Hola!: Soy físico durante el día, lector de manga por las noches y este es mi blog. Vivo en Albacete y tengo un gato llamado Alex. Me encantan los mojitos (y mirar a la gente corriendo en los parques)</blockquote>\n\nO algo así:\n\n<blockquote>La empresa Calcetines XYC se fundó en 1973, y ha estado produciendo calcetines de calidad para sus clientes desde entonces. Se encuentra en Vetusta, tiene unos 2.000 empleados e intenta ayudar en lo que puede para mejorar la vida en Vestusta</blockquote>\n\nDeberías ir a <a href="http://localhost:8888/wp-admin/">tu escritorio</a>, borrar esta página y crear algunas nuevas con tu contenido. ¡A divertirse!', 'Página de ejemplo', '', 'publish', 'open', 'open', '', 'pagina-ejemplo', '', '', '2012-11-27 17:16:00', '2012-11-27 17:16:00', '', 0, 'http://localhost:8888/?page_id=2', 0, 'page', '', 0),
(3, 1, '2012-11-27 17:16:14', '0000-00-00 00:00:00', '', 'Borrador automático', '', 'auto-draft', 'open', 'open', '', '', '', '', '2012-11-27 17:16:14', '0000-00-00 00:00:00', '', 0, 'http://localhost:8888/?p=3', 0, 'post', '', 0);
...
(1, 'admin', '$P$BUTgQCWAQtKQfEknsbbq3tMI/Z.aUD0', 'admin', 'developers@bueninvento.es', '', '2012-11-27 17:16:00', '', 0, 'admin');
