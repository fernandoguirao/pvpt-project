					...
					<div id="myCarousel" class="carousel slide"> 
						 ...
						 <div class="carousel-inner" >
							 <div class="active item">
								<img src="<?php bloginfo('template_url'); ?>/img/contenidos/slide01.jpg" alt="" width="100%" />
								<div class="container">
									<div class="fix-ie7">
										<div class="carousel-caption">
											...
											<div class="nav-carousel hidden-phone hidden-tablet">
												<div class="thumb car-1 activo">
													...
													<img src="<?php bloginfo('template_url'); ?>/img/contenidos/slide01.jpg" alt="" width="200px" />
							...
							<ul class="thumbnails">
								...
								<li class="span3">
									<a href="" class="thumbnail th2">
										<div class="mascara">
											<img src="<?php bloginfo('template_url'); ?>/img/sprites/foot-img02.jpg" width="100%" alt="">
										</div>
										<div class="texto-th">
											<h2>Nuestros cursos</h2>
											<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
									...
									<a href="" class="thumbnail th6">
										<div class="mascara">
											<img src="<?php bloginfo('template_url'); ?>/img/sprites/foot-img03.jpg" width="100%" alt="">
										</div>
										<div class="texto-th">
											<h2>Nuestros cursos</h2>
											<p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
